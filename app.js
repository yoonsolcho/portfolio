...
const projectDetails = {
  '403-bypass': {
    ...
    learn: '• <b>배리어프리 디자인과 용어 습득</b>\n이번 프로젝트를 통해 배리어프리나 유니버설 디자인 같은 관련 용어들을 새로 배울 수 있었습니다.\n\n• <b>"360º 뷰어" 단독 구현 경험</b>\n"360º 뷰어" 기능을 웹 환경에서 실제로 직접 구현해 보며 구현 방법과 기술을 익혔습니다.\n\n• <b>주도적 소통과 실행의 가치 체감</b>\n팀 프로젝트를 기획하며 서로 의견을 나누고 소통하는 과정이 얼마나 중요한지 배웠습니다. 특히 좋은 아이디어가 있을 때 팀원들과 아낌없이 공유하고, 구현할 거리라면 주저하지 않고 직접 실행으로 옮기는 적극적인 시도가 최우수상이라는 좋은 결과로 이어지는 과정을 직접 체감할 수 있었습니다.'
  },
  'gentle-monster': {
    ...
    learn: '• <b>전통 원형의 현대적 브랜딩 기획</b>\n한국의 전통 금속 공예라는 고전적 요소를 현대적인 상업 콘텐츠로 가공하고 브랜딩하는 기획 프로세스를 경험했습니다.\n\n• <b>팀 협업을 이끄는 적극적인 태도</b>\n팀원들과의 활발한 소통을 위해 먼저 한 발짝 앞서 다가가고 주도적으로 의견을 나누는 적극적인 자세의 중요성을 느꼈습니다.\n\n• <b>청중 중심의 프레젠테이션 스킬</b>\n프로젝트 발표를 진행하며 단순히 내용을 읊는 것이 아니라 청중과 눈을 맞추고 상호작용하며 설명하는 양방향 소통 방식의 필요성을 배웠습니다.'
  },
  'place-marketing': {
    title: '춘천 관광 마케팅 제안서',
  ...
  'ai-basic': {
    ...
    learn: '• <b>생성형 AI 기술의 교육적 접목 이해</b>\n생성형 AI 기술(GPT API, STT)을 취업 교육 및 면접 피드백 서비스 모델에 어떻게 융합하고 적용할 수 있는지에 대한 공학적 흐름을 이해할 수 있었습니다.\n\n• <b>기술의 실질적 제품화 기획 역량</b>\n추상적인 인공지능 기술의 가능성을 사용자 시나리오와 프로토타입 스토리보드 설계를 통해 실제 가치를 주는 서비스 모델로 기획하고 제품화해 보는 뜻깊은 경험이었습니다.'
  }
};
